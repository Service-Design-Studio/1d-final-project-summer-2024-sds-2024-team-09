    ...
    visitor: {
      ...
      MemberExpression: {
        ...
        exit: function exit(path) {
          ...
          if (path.scope.getBindingIdentifier(obj.name)) return;
          path.replaceWith(t.memberExpression(this.addDefaultImport(moduleName + "/core-js/" + _definitions.default.builtins[obj.name], obj.name), node.property, node.computed));
        }
      }
    }
  };
