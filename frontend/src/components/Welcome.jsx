        ...
        <div className="container mt-5">
            <div className="text-center">
                ...
                <div className="d-flex justify-content-center mt-4">
                    <a href="/user" className="btn btn-primary btn-lg text-white mx-2">User Page</a>
                    <a href="/camlogin" className="btn btn-secondary text-black btn-lg mx-2">Camera Page</a>
