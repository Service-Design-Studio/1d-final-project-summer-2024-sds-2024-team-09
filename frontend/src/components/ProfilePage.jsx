                    ...
                    <div class="card w-96 h-24 rounded-xl bg-white shadow rounded-badge">
                        <Link to="/profile/particulars">
                            <div class="card h-12 px-4 flex flex-row items-center">
                                ...
                                <div className='flex-1 px-4 text-xl font-lato text-primary font-semibold'>Edit Your Particulars</div>
                        ...
                        <Link to="/profile/accsettings">
                            <div class="card h-12 px-4 flex flex-row items-center">
                                ...
                                <div className='flex-1 px-4 text-xl font-lato text-primary font-semibold'>Edit Account Settings</div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="17" viewBox="0 0 10 17" fill="none">
                                    <path fill="#C3C6CF" d="M9.6024 9.4443L1.92021 17L0 15.1114L6.72209 8.5L0 1.88859L1.92021 0L9.6024 7.5557C9.85698 7.80617 10 8.14584 10 8.5C10 8.85416 9.85698 9.19383 9.6024 9.4443Z"></path>
                                </svg>
                            </div>
                ...
                <div className='flex justify-center py-2'>
                    <div class="card w-96 h-24 rounded-xl bg-white shadow rounded-badge">
                        <div class="card h-full px-4 flex flex-row items-center">
                            ...
                            <div className='flex-1 px-4 text-xl font-lato text-primary font-semibold'>Enable Telegram</div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="17" viewBox="0 0 10 17" fill="none">
                                <path fill="#C3C6CF" d="M9.6024 9.4443L1.92021 17L0 15.1114L6.72209 8.5L0 1.88859L1.92021 0L9.6024 7.5557C9.85698 7.80617 10 8.14584 10 8.5C10 8.85416 9.85698 9.19383 9.6024 9.4443Z"></path>
                            </svg>
                        </div>
                        ...
                        <div class="card h-full px-4 flex flex-row items-center">
                            ...
                            <div className='flex-1 px-4 text-xl font-lato text-primary font-semibold'>Edit Cry Detection Settings</div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="17" viewBox="0 0 10 17" fill="none">
                                <path fill="#C3C6CF" d="M9.6024 9.4443L1.92021 17L0 15.1114L6.72209 8.5L0 1.88859L1.92021 0L9.6024 7.5557C9.85698 7.80617 10 8.14584 10 8.5C10 8.85416 9.85698 9.19383 9.6024 9.4443Z"></path>
                            </svg>
                        </div>
                    ...
                    <div class="card w-96 h-24 rounded-xl bg-white shadow rounded-badge">
                        <Link to="/profile/editcams">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="21" viewBox="0 0 25 21" fill="none">
                                ...
                                <div className='flex-1 px-4 text-xl font-lato text-primary font-semibold'>Add/Delete Camera</div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="17" viewBox="0 0 10 17" fill="none">
                                    <path fill="#C3C6CF" d="M9.6024 9.4443L1.92021 17L0 15.1114L6.72209 8.5L0 1.88859L1.92021 0L9.6024 7.5557C9.85698 7.80617 10 8.14584 10 8.5C10 8.85416 9.85698 9.19383 9.6024 9.4443Z"></path>
                                </svg>
                            </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="29" height="24" viewBox="0 0 29 24" fill="none">
                            ...
                            <div className='flex-1 px-4 text-xl font-lato text-primary font-semibold'>Trusted Members</div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="17" viewBox="0 0 10 17" fill="none">
                                <path fill="#C3C6CF" d="M9.6024 9.4443L1.92021 17L0 15.1114L6.72209 8.5L0 1.88859L1.92021 0L9.6024 7.5557C9.85698 7.80617 10 8.14584 10 8.5C10 8.85416 9.85698 9.19383 9.6024 9.4443Z"></path>
                            </svg>
                        </div>
